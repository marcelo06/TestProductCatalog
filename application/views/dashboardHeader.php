...
<html lang="en">
	...
	<div class="bg-light border-right" id="sidebar-wrapper">
		...
		<div class="list-group list-group-flush">
			...
			<a href="<?= base_url('categories'); ?>" data-item="categories" class="list-group-item list-group-item-action bg-light">Categories</a>
		  <a href="<?= base_url('products'); ?>" data-item="products" class="list-group-item list-group-item-action bg-light">Products</a>
		  <a href="<?= base_url('users'); ?>" data-item="users" id="userLink" class="list-group-item list-group-item-action bg-light">Users</a>
		</div>
	</div>
	<!-- /#sidebar-wrapper -->
